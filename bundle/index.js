...
class Conditional {
    constructor(filePath, lineNumber, columnNumber) {
        this.filePath = filePath;
        this.lineNumber = lineNumber;
        this.columnNumber = columnNumber;
    }
    static newInstance(filePath, lineNumber, columnNumber) {
...
const ConditionalDetector_1 = __importDefault(__webpack_require__(834));
function run() {
...
Object.defineProperty(exports, "__esModule", { value: true });
const Conditional_1 = __importDefault(__webpack_require__(50));
const fs_1 = __webpack_require__(747);
const PositionCalculator_1 = __importDefault(__webpack_require__(580));
class ConditionalDetector {
    constructor(filePath) {
        this.currentMatch = null;
        this.conditionals = [];
        this.filePath = filePath;
        this.fileContent = fs_1.readFileSync(filePath).toString();
        this.positionCalculator = new PositionCalculator_1.default(this.fileContent);
    ...
    addConditionalAt(index) {
        const position = this.positionCalculator.getPositionData(index);
        this.conditionals.push(Conditional_1.default.newInstance(this.filePath, position.line, position.column));
    }
    setCurrentMatchToNextMatch() {
        this.currentMatch = ConditionalDetector.IF_REG_EX.exec(this.fileContent);
    }
}
exports.default = ConditionalDetector;
ConditionalDetector.IF_REG_EX = /((?:[ \t]|^)if ?\()|(\/\*[\s\S]*?\*\/|\/\/.*)/gm;
